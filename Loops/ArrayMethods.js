...
//Exercise:-
const Friends = [{name: `Prasanth Korsapati`},
                 {name: `Tulluri Jack`},
                 {name: `Hari`},
                 {name: `Purna`},
                 {name:`Kolli Gopi`},
...
function findOut(Customer) {
  ...
  Bought === true ? (console.log(`Yeah, he bought it`)): (console.log(`No he didn't bought`));
}
...
function leaveCheck(employ){
  ...
  Employ === true ? (console.log(`He attended the whole month`)):(console.log(`He taken leave`));
}
